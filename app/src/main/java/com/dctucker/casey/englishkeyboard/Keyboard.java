...
public class Keyboard {
    ...
    public static class Row {
        ...
        public Row(Resources res, Keyboard parent, XmlResourceParser parser) {
            ...
            if (parent.mLayoutRows >= 5) {
                ...
                float topScale = 0.4f; //LatinIME.sKeyboardSettings.topRowScale;
    ...
    public static class Key {
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            if (codes == null && !TextUtils.isEmpty(label)) {
                ...
                if (codes != null && codes.length == 1) {
                    //final Locale locale = "ime";//LatinIME.sKeyboardSettings.inputLocale;
                    String upperLabel = "ime";//label.toString().toUpperCase(locale);
                    if (shiftLabel == null) {
        ...
        public Keyboard getPopupKeyboard(Context context, int padding) {
            ...
            if (popup.length() > 0) {
                ...
                if (resId == 0) resId = R.xml.keyboard_popup_template;
    ...
    public Keyboard(Context context, int defaultHeight, int xmlLayoutResId, int modeId, float kbHeightPercent) {
        ...
        mUseExtension = true;//LatinIME.sKeyboardSettings.useExtension;
        loadKeyboard(context, context.getResources().getXml(xmlLayoutResId));
        setEdgeFlags();
        //fixAltChars("ime"); //LatinIME.sKeyboardSettings.inputLocale);
    }
                    ...
                    if (TAG_ROW.equals(tag)) {
                        ...
                        if (key.codes == null) {
                            ...
                            if (key.codes[0] == KEYCODE_SHIFT) {
                                ...
                                mModifierKeys.add(key);
                            } else if (key.codes[0] == EnglishKeyboardView.KEYCODE_CTRL_LEFT) {
                                mCtrlKey = key;
                            } else if (key.codes[0] == EnglishKeyboardView.KEYCODE_ALT_LEFT) {
                                mAltKey = key;
                            } else if (key.codes[0] == EnglishKeyboardView.KEYCODE_META_LEFT) {
                                mMetaKey = key;
                            }
                        }
